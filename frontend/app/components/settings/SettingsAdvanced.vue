...
import {
  TimerIcon, TerminalIcon, DatabaseIcon, HardDriveIcon,
  AlertTriangleIcon, Trash2Icon
...
initFields(['pollInterval', 'retention', 'defaultThreshold', 'defaultTarget', 'deletionsEnabled', 'logLevel'])
