          ...
          <UiTable>
            <UiTableHeader class="sticky top-0 z-10 bg-background">
              <UiTableRow>
                ...
                >
                  <span :class="['inline-flex items-center gap-1', col.key === 'size' ? 'justify-end' : '']">
                    {{ col.label }}
                    <ArrowUpIcon
...
import { RefreshCwIcon, LoaderCircleIcon, CheckIcon, ChevronRightIcon, SearchIcon, ShieldCheckIcon, ArrowUpIcon, ArrowDownIcon, ArrowUpDownIcon } from 'lucide-vue-next'
...
const props = defineProps<{
  ...
  loading: boolean
  fetchedAt: string
  diskContext: { totalBytes: number; usedBytes: number; targetPct: number; thresholdPct: number; bytesToFree: number } | null
}>()
...
watch([previewSearch, previewTypeFilter, previewStatusFilter, previewSortBy, previewSortDir, () => props.preview], () => {
